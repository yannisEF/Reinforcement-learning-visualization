...
if __name__ == "__main__":
	...
	parser.add_argument('--nb_lines', default=10, type=int)# number of directions generated,good value : precise 100, fast 60, ultrafast 50
	...
	parser.add_argument('--stepalpha', default=1, type=float)# step for alpha in the loop, good value : precise 0.5 or 1, less precise 2 or 3
