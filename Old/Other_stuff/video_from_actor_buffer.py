...
if __name__ == "__main__":
    ...
    #paramètres :
    output_video_dir = './video_actor/filled' # /!\ Nom du dossier où enregistrer la vidéo
    actor_directory = "resMemory" # /!\ dossier où se trouve l'acteur
    actor_filename = "actor_td3_buffer_3_step_2_80000" # /!\ nom du fichier de l'acteur (sans l'extension)
