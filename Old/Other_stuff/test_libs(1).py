...
if __name__ == "__main__":
    ...
    parser.add_argument('--env', default='Swimmer-v2', type=str)#HalfCheetah-v2
    ...
    # ES parameters
    parser.add_argument('--pop_size', default=10, type=int)#10
    ...
    parser.add_argument('--max_steps', default=1000000, type=int)#1000000
    ...
    parser.add_argument('--period', default=5000, type=int)#5000
