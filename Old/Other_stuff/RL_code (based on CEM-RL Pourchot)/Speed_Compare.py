...
if __name__ == "__main__":
    ...
    actors_directory = "actors_compare"
    actors_to_compare = ["actor_good","actor_td3_140000_U_jiggle"]
    color_plot = ['b','r']
    #evaluate speed :
    plots = []
    for act_file in actors_to_compare:
        ...
        plots.append(speeds[0])

    # Plot result
    plt.figure()
    for i in range(len(plots)):
        plt.plot(list(range(len(plots[i]))), plots[i], color = color_plot[i])
