...
if __name__ == "__main__":
    ...
    parser.add_argument('--max_steps', default=100000, type=int)#1000000
    ...
    parser.add_argument('--period', default=4000, type=int)#5000
    parser.add_argument('--n_eval', default=8, type=int)#10
