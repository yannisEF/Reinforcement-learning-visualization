...
echo
python3 Vignette.py --env Pendulum-v0 --inputDir Models --basename example_pendulum --min_iter 8000 --max_iter 8501 --step_iter 500 --eval_maxiter 1 --nb_lines 10 --policiesPath ComparePolicies/example_around_8000.xz
clear
echo Loading the computed Vignette...
echo
python3 savedVignette.py --directory SavedVignette --filename example_pendulum
